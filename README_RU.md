...
- **Конвертация в xlsx и pdf**: имеет возможность конвертации полученных данных в xlsx (excel) и pdf формат
...
- **Аналитика отзывов и лотов**: имеет возможность проводить полноценную аналитику профиля магазина по отзывам и средней оценке, а так же имеет возможность проводить полный анализ лота (карточки товара) по ссылкам
...
- `os` — нахождение файлов с готовыми данными. 
...
### 1. Скачивание
Перейдите на страницу [Releases](https://github.com/mustafaev33/funpay_analytics_script/releases) и скачайте последний архив `FunPayAnalytics_v1.2.0.zip`.
...
![Аналитика отзывов](screenshots/rev_analytics.png)
*Рисунок 7: Аналитика отзывов магазина со средней оценкой и ключевыми словами*

![Аналитика лотов](screenshots/lot_analytics.png)
*Рисунок 8: Аналитика лотов по ссылке с полной доступной информацией и описанием*

### Графики
![Графики и диаграммы](screenshots/visual.png)
*Рисунок 9: Показ графиков и диаграммы по показателям*
